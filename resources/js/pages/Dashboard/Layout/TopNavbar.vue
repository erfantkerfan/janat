                ...
                <div class="md-collapse">
                    ...
                    <md-list>
                        <md-list-item href="/">
                            ...
                            <p class="hidden-lg hidden-md">سایت</p>
                        </md-list-item>
                        <md-list-item v-if="$route.name !== 'Dashboard'" @click="goToDashboard">
                            <i class="material-icons">dashboard</i>
                            <p class="hidden-lg hidden-md">پیشخوان</p>
                        </md-list-item>
                        ...
                        <md-list-item v-if="$route.name !== 'User.Show'" @click="goToUserProfile">
                            <i class="material-icons">person</i>
                            <p class="hidden-lg hidden-md">حساب کاربری</p>
                        </md-list-item>
                    </md-list>
                </div>
            </div>
